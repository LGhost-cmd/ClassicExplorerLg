...
# v6.4 -> v6.6 -> v7.0 -> v7.1 -> v7.2 -> v7.3 -> v7.4 -> v7.5.
...
print(
    ...
    "v7.4 My Chats/global search plus periodic update reconciliation, and v7.5 "
    "photo retry/top-bar spacing/history pagination hardening."
)
